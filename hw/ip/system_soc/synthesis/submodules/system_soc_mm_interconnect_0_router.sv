...
(
    ...
    localparam PAD2 = log2ceil(64'h8060 - 64'h8040); 
    localparam PAD3 = log2ceil(64'h8080 - 64'h8060); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h8080;
    ...
    // ( 0x8040 .. 0x8060 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 16'h8040   ) begin
            src_channel = 4'b1000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x8060 .. 0x8080 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 16'h8060   ) begin
            src_channel = 4'b0100;
